	...
	int Publisher(int argc, char *argv[]) {
		...
		try
		{
			...
			if (user.userID() == TERMINATION_MESSAGE)
			{
				...
				msg.title() = "柠檬市场扩张导致黑手党崛起";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\AI.jpg";
				...
				msg.title() = "疫苗供不应求供应量一半";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\carton.jpg";
				...
				msg.title() = "古典学教授讲述千年罗马史";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\city.jpg";
				...
				msg.title() = "泉港区“碳九”泄漏第五天尚无最终定论";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\design.jpg";
				...
				msg.title() = "星巴克要涨价免费咖啡券也减少了";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\dog.jpg";
				...
				msg.title() = "平安入股汇丰后成第一大股东";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\food.jpg";
				...
				msg.title() = "《重庆日报》说重庆高考要政审";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\movie.jpg";
				...
				msg.title() = "手机辐射致鼠患癌不能推广到人类";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\xing.jpg";
				...
				msg.title() = "爱因斯坦世界观书籍出版";
				msg.pic_url() = "..\\..\\SAADP-UI\\Image\\friends.jpg";
