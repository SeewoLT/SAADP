    ...
    ui(new Ui::Widget)
{
    ...
    int topBtnNum = 5; //记录top中按钮个数
    int midBtnNum = 15; //记录mid中按钮个数
    int btmBtnNum = 15; //记录btm中按钮的个数
...
//top部分
{
    ...
    ui->topScrollArea->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
    ...
    QString topurl[5] = {"QPushButton{border-image: url(:/new/Image/AI.jpg)}",
                         "QPushButton{border-image: url(:/new/Image/dog.jpg)}",
                         "QPushButton{border-image: url(:/new/Image/city.jpg)}",
                         "QPushButton{border-image: url(:/new/Image/carton.jpg)}",
                         "QPushButton{border-image: url(:/new/Image/food.jpg)}"};
    ...
    for(int i = 0; i < topBtnNum; i++)
    {
        ...
        topArticleBtn[i].setStyleSheet(topurl[i]);
...
//mid部分
{
    ...
    for(int i = 0; i < midBtnNum; i++)
    {
        ...
        midArticleBtn[i].setStyleSheet(midurl[i%3] + "QPushButton{border-radius: 10px;}");
...
//btm部分
{
    ...
    for(int i = 0; i < btmBtnNum; i++)
    {
        ...
        btmArticleBtn[i].setStyleSheet(btmurl[i%3] + "QPushButton{border-radius: 10px;}");
        btmWidget->setMouseTracking(true); //激活鼠标跟踪
